...
from .views import index, RegisterView, profile, edit_profile, identify_plant, LigthNav, Chart, Table, NotFound, Unauthorised, ServerError
...
urlpatterns = [
    ...
    path('dashboard/layout-static/', identify_plant, name='identify-plant'),
