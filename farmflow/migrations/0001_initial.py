# Generated by Django 4.2 on 2023-05-04 23:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(choices=[('Grade A', 'Grade A'), ('Grade B', 'Grade B'), ('Grade C', 'Grade C')], max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Complete', 'Complete'), ('Partial', 'Partial')], max_length=255, unique=True)),
                ('done', models.CharField(choices=[('Y', 'YES'), ('N', 'NO')], max_length=255, unique=True)),
